...
const AdminSetting1 = () => {
  ...
  const container = document.getElementsByClassName('blur-content')[0];
      ...
      <Layout>
        ...
        >
          ...
          >
            ...
            <Breadcrumb.Item>Recognition Type Setting</Breadcrumb.Item>
          </Breadcrumb>
          <div
            style={{
              padding: 24,
